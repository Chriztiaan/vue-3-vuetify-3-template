	...
	<v-card width="600" flat>
		...
		<div v-else class="d-flex flex-column">
			...
			<div class="d-flex align-center mt-2">
				<v-text-field v-model="taskText" hide-details variant="outlined" density="compact" placeholder="New task name..."> </v-text-field>
				<v-btn class="ml-4" :disabled="disableCreate" icon="mdi-plus" size="40" rounded="lg" variant="outlined" @click="addTask" />
			</div>
		</div>
	</v-card>
</template>
